  ...
  <div>
        ...
        <div class="task-r divide-main">
          <div class="panel">
            <div class="panel-header">
              ...
              <div class="panel-header-tools">
                <Button type="primary"
                        @click="() => word.show = true">修改话术模版</Button>
                <Button type="primary"
                  ...
                  <div class="task-detail">
                    ...
                    <div class="mt-20">
                      <Row>
                        ...
                        <i-col span="8">
                          <p>
                            <b>机器坐席号码: 13855556666</b>
                          </p>
                        </i-col>
                        <i-col span="8">
                          <p>
                            <b>话术模版: 微码自售机器人(模版1)</b>
                          </p>
                        </i-col>
                      </Row>
                      <Row>
                        ...
                        <i-col span="8">
                          <p>
                            <b>启动时间: 2018-12-12 12:12:12</b>
                          </p>
                        </i-col>
                        <i-col span="8">
                          <p>
                            <b>外呼时间: 每天08:00-12:00 14:00-18:00</b>
                          </p>
                        </i-col>
                      </Row>
                    </div>
    ...
    <Modal v-model="word.show"
      ...
      <div class="task-detail padding-10">
        <h3>请选择话术模版</h3>
        <p class="help-block">注: 修改话术模版后，将从下一个呼叫电话开始，使用修改后的话术模版</p>
